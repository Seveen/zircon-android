...
import org.hexworks.zircon.internal.tileset.transformer.AndroidTextureCloner
import java.util.concurrent.TimeUnit
import org.hexworks.zircon.internal.tileset.transformer.AndroidTextureColorizer
import org.hexworks.zircon.internal.util.Assets

/**
 * Represents a tileset which is backed by a sprite sheet.
 */
class AndroidTileset(override val width: Int,
...
//    private val cache = LruCache<String, TileTexture<TextureRegion>>(1)
...
//        val maybeRegion = cache.get(key)
    ...
    companion object {
        ...
        private val TILE_INITIALIZERS = listOf(
                AndroidTextureCloner(),
                AndroidTextureColorizer()
        )
    }
