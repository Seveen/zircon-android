...
class ZirconInputListener(private val fontWidth: Int,
    ...
    override fun scrolled(amount: Int): Boolean {
        ...
        (0..amount).forEach {
            processMouseEvent(actionType, 0, 0, 0)
        }
        return true
    }
    ...
    override fun touchDragged(screenX: Int, screenY: Int, pointer: Int): Boolean {
        clicking = false
        processMouseEvent(MouseEventType.MOUSE_DRAGGED, screenX, screenY, 0)
        return true
    }
    ...
    override fun mouseMoved(screenX: Int, screenY: Int): Boolean {
        processMouseEvent(MouseEventType.MOUSE_MOVED, screenX, screenY, 0)
        return true
    }
